package com.hypocriticalfish.crowdfunding.constant;

/**
 * @Author Hypocritical Fish
 * @Create 2022/4/26 22:22
 * @Description
 */
public class CrowdConstant {
    ...
    public static final String MESSAGE_HEADER_PIC_EMPTY = "请上传头图文件！";
    public static final String MESSAGE_DETAIL_PIC_EMPTY = "请上传项目详情图片！";
