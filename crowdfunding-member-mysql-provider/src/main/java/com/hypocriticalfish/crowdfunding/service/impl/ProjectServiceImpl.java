...
import com.hypocriticalfish.crowdfunding.entity.po.ProjectPO;
import com.hypocriticalfish.crowdfunding.entity.po.ReturnPO;
import com.hypocriticalfish.crowdfunding.entity.vo.*;
import com.hypocriticalfish.crowdfunding.mapper.*;
...
public class ProjectServiceImpl implements ProjectService {
    ...
    final private Logger logger = LoggerFactory.getLogger(ProjectServiceImpl.class);
    ...
    public DetailProjectVO getDetailProjectVO(Integer projectId) {
        ...
        if (detailProjectVO == null) {
            ...
            logger.error("项目不存在，项目编号："+ projectId);
            return null;
        }
    ...
    public List<PortalTypeVO> getPortalTypeVO() {
        ...
        return projectPOMapper.selectProtalTypeVOList();
    }
