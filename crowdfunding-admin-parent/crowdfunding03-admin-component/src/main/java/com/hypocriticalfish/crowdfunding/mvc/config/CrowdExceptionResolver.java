 ...
 * @Create 2022/4/26 22:18
 * @Description 注解@ControllerAdvice将该类声明为一个异常处理类
 */
@ControllerAdvice
public class CrowdExceptionResolver {
    ...
    public ModelAndView resolveLoginFailedException(LoginAcctAlreadyInUseException exception, HttpServletRequest request, HttpServletResponse response) throws IOException {
